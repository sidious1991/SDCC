...
var netGen = function (zn, group) {
  ...
  function (err, results) {
    /*la rete della vpc viene filtrata in base all'appartenenza al gruppo login,
    così avremo filterNet che contiene il master della rete ed in esaredNet i peer*/
