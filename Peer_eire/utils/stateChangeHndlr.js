...
exports.allSubscriptions = function allSubscriptions() {
    ...
    snsapi.subscribe('arn:aws:sns:eu-west-1:993460052932:eire_leader_topic', 'eu-west-1');
}
...
exports.unsubscribeAll = function unsubscribeAll() {
    snsapi.unsubscribe('arn:aws:sns:eu-west-1:993460052932:eire_leader_topic', 'eu-west-1');
}
