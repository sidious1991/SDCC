...
var gameChanger = function(actualState,timer){
  switch (actualState) {
    ...
    case "No more bets":
      ...
      noMoreBet();
        setTimeout(function(){
            $.get("http://eireLoad-507879366.eu-west-1.elb.amazonaws.com/roulette/raftState", function(data, status){
    ...
    case "Payment":
      ...
      setTimeout(function(){
        ...
        $.get("http://eireLoad-507879366.eu-west-1.elb.amazonaws.com/roulette/raftState", function(data, status){
          ...
          $.post("http://eireLoad-507879366.eu-west-1.elb.amazonaws.com/roulette/getCash",data_l, function(data, status){
...
$( document ).ready(function(){
  ...
  if($.cookie('infoLogin')== undefined){
    ...
    $.post("http://eireLoad-507879366.eu-west-1.elb.amazonaws.com/roulette/getCash",data_l, function(data, status){
      console.log("data.cash",data,data.cash)
       if(data.cash != undefined ){
...
$('#confirm-access').click(function(){
  ...
  $.get('http://eireLoad-507879366.eu-west-1.elb.amazonaws.com/roulette/getDailyNumber',function(data){
