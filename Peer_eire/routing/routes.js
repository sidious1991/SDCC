...
router.get('/login/:id', function(req, res){
  ...
  res.cookie('infoLogin',JSON.stringify(obj),{domain:'eu-west-1.elb.amazonaws.com'});
  res.redirect('http://eireload-507879366.eu-west-1.elb.amazonaws.com/index.html');
...
router.post('/getCash',urlencodedParser, function (req, res, message) {
  ...
  // Sends {cash: cash} or {}
  console.log("get cash router",req.body)
